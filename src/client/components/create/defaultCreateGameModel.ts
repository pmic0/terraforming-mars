...
export function defaultCreateGameModel(): CreateGameModel {
  return {
    ...
    players: [
      ...
      {name: '', color: 'lred', beginner: false, handicap: 0, first: false},
      {name: '', color: 'lyellow', beginner: false, handicap: 0, first: false},
      {name: '', color: 'lgreen', beginner: false, handicap: 0, first: false},
      {name: '', color: 'lblue', beginner: false, handicap: 0, first: false},            
      ],
